...
<?php
  ...
  $query ="SELECT * from policy_source ORDER BY no";
  //Get results
...
<html lang="en">
  ...
  <div class="container">
    ...
    <?php 
	  ...
	  $output .='<td>'.$row['id'].'</td>';
	  $output .='<td><a href="run_script_policy_source.php?id='.$row['no'].'" class="btn btn-success"">Script</a></td>';
	  $output .='</tr>';
	 ...
	 <p> </p>
         ...
         <p> </p>
           ...
           <form method="post" action="policy_source_fetch_all.php">
