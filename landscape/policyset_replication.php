...
<?php
  ...
  $query ="SELECT * from policysetauthen ORDER BY id";
  //Get results
...
<html lang="en">
  ...
  <div class="container">
	  ...
	  <h2> Policy Sets Status </h2>
		<p> Please use this page for authorization only after authenticaiton. </p>
    ...
    <?php 
	  ...
	  $output .='<td><a href="run_script_authen_put.php?id='.$row['id'].'" class="btn btn-success"">Replicate</a></td>';
	  $output .='</tr>';
